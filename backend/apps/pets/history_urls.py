...
from .views import (
    PetHistoryListCreateView,
    PetHistoryRetrieveUpdateDestroyView,
...
urlpatterns = [
    # 히스토리 전체 항목 
    path('', PetHistoryListCreateView.as_view(), name='pet-history-list-create'),
    path('<int:history_id>/', PetHistoryRetrieveUpdateDestroyView.as_view(), name='pet-history-detail'),
