...
class Place(BaseModel):
    ...
    # API 통합을 위해 남겨둔 필드
    source = models.CharField(max_length=50, null=True, blank=False)
    raw_data = models.JSONField(null=True, blank=True)
    kcisa_id = models.CharField(max_length=100, unique=True, null=True, blank=True)
    ktour_content_id = models.CharField(max_length=50, unique=True, null=True, blank=True)
